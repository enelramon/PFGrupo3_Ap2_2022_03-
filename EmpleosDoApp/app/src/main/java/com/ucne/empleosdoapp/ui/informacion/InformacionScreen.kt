...
private fun TextoInfo(){
    Column(modifier = Modifier.padding(4.dp, 0.dp)) {
        ...
        Text(text = "Accede a una gran cantidad de disponibilidad de empleos más recientes en república dominicana y aplica a ellos de una forma fácil y sencilla.\n", fontSize = 14.sp)
        Text(text = "También conoces como es la forma de trabajar de estas empresas, ubicación, requisitos, sueldos, entre otros. Encontraras todas las informaciones necesarias para entrar al mercado laboral.\n", fontSize = 14.sp)
    }
}